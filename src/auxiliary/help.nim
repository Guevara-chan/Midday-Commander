const core_help* = [
    ...
    "\a\x07Numpad|\a\x02Left:\a\x01    move commandline cursor left 1 character back",
    "\a\x07Numpad|\a\x02Right:\a\x01   move commandline cursor left 1 character forward",
    "\a\x07Numpad|\a\x02Home:\a\x01    move commandline cursor to start of line",
    "\a\x07Numpad|\a\x02End:\a\x01     move commandline cursor to end of line",
    "\a\x07Numpad|\a\x02Insert:\a\x01  switch insertion/replacement commandline input modes",
    "\a\x07Numpad|\a\x02Del:\a\x01     delete selected char in commandline",
    ...
    "\a\x07Numpad|\a\x02/:\a\x01       browse parent dir",
    "\a\x01===================================================================================",
